function [colorte,invcolorte,colormi,colorcami,invcolorcami,colordiridx,...
    pcami_xy,pcami_yx,cami_xy,cami_yx,mi,diridx,te_xy,te_yx] = ...
    calcpointwise(x,y,l_past,l_future,xlinepos,ylinepos,tau,delay,units)
% CALCPOINTWISE Calculates the Pointwise Information Measures
% Cite:
...
%--------------------------------------------------------
% Example:     
%	   [colorte,invcolorte,colormi,colorcami,invcolorcami,colordiridx,...
%        pcami_xy,pcami_yx,cami_xy,cami_yx,mi,diridx,te_xy,te_yx] = ...
%        calcpointwise(cause,effect,2,2,linspace(0.1,1,3),linspace(0.1,1,3),1,0,'bits'); 
%--------------------------------------------------------
% (CC-BY-NC-4.0) Arthur Valencio* and Dr Murilo S. Baptista, 13 Jun 2018
